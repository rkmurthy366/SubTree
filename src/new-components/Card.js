...
<div class="bg-slate-200 flex justify-center items-center py-20">
    <div class="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
      <h3 class="mb-3 text-xl font-bold text-gray-600">Beginner Friendly</h3>
      <div class="relative">
      ...
      <div class="my-4">
        <div class="flex space-x-1 items-center">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 mb-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button class="mt-4 text-xl w-full text-white bg-gray-600 py-2 rounded-xl shadow-lg">Buy This Plan</button>
      </div>
    </div>
